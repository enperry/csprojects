...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        """
        # mark cell as move that's been made
        ...
        # remove cells of neighbors of which we already know the states of, update mine count accordingly
        mine_count = count
        ...
        # mark other cells as safe/mines as can be determined w/ knowledge base
        mines_to_mark = set()
        safes_to_mark = set()
        for sentence in self.knowledge:
        ...
        # remove obsolete knowledge sentences
        sentences_to_remove = []
        for sentence in self.knowledge:
        ...
        # using subset method, add to knowledge base w/ inference
        knowledge_to_add = []
        for sentence in self.knowledge:
        ...
        print("Number of sentences in knowledge base: " + str(len(self.knowledge)))
        for sentence in self.knowledge:
    ...
    def make_safe_move(self):
        ...
        # no more unique safe moves exist 
        return None
    ...
    def get_neighbors(self, cell):
        """
        Returns a set of all neighbors of cell (i, j)
        """
        i, j = cell[0], cell[1]
        neighborcandidates = [(i - 1, j),
                            (i + 1, j),
                            (i, j - 1),
                            (i, j + 1),
                            (i - 1, j - 1),
        ...
        for neighbor in neighborcandidates:
            if(0 <= neighbor[0] and neighbor[0] < self.height):
                if(0 <= neighbor[1] and neighbor[1] < self.width):
